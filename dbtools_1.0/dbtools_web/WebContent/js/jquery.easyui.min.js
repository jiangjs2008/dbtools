...
(function ($) {
	...
	$.fn.resizable.parseOptions = function (_6e) {
		var t = $(_6e);
		return $.extend({ }, $.parser.parseOptions(_6e, [
			'handles',
			{
				minWidth: 'number',
				minHeight: 'number',
...
(function ($) {
	...
	$.fn.linkbutton.parseOptions = function (_80) {
		var t = $(_80);
		return $.extend({ }, $.parser.parseOptions(_80, [
			'id',
			'iconCls',
			'iconAlign',
			'group',
...
(function ($) {
	...
	$.fn.tree.parseOptions = function (_197) {
		var t = $(_197);
		return $.extend({ }, $.parser.parseOptions(_197, [
			'url',
			'method',
			{
				checkbox: 'boolean',
...
(function ($) {
	...
	$.fn.progressbar.parseOptions = function (_1c1) {
		return $.extend({ }, $.parser.parseOptions(_1c1, [
			'width',
			'height',
			'text',
			{
...
(function ($) {
	...
	$.fn.tooltip.parseOptions = function (_1e0) {
		var t = $(_1e0);
		var opts = $.extend({ }, $.parser.parseOptions(_1e0, [
			'position',
			'showEvent',
			'hideEvent',
			'content',
...
(function ($) {
	...
	$.fn.panel.parseOptions = function (_231) {
		var t = $(_231);
		return $.extend({ }, $.parser.parseOptions(_231, [
			'id',
			'width',
			'height',
			'left',
...
(function ($) {
	...
	$.fn.dialog.parseOptions = function (_278) {
		return $.extend({ }, $.fn.window.parseOptions(_278), $.parser.parseOptions(_278, [
			'toolbar',
			'buttons'
		]));
	};
...
(function ($) {
	...
	$.fn.accordion.parseOptions = function (_2dd) {
		var t = $(_2dd);
		return $.extend({ }, $.parser.parseOptions(_2dd, [
			'width',
			'height',
			{
				fit: 'boolean',
...
(function ($) {
	...
	$.fn.tabs.parseOptions = function (_352) {
		return $.extend({ }, $.parser.parseOptions(_352, [
			'width',
			'height',
			'tools',
			'toolPosition',
...
(function ($) {
	...
	$.fn.layout.parsePanelOptions = function (_3a5) {
		var t = $(_3a5);
		return $.extend({ }, $.fn.panel.parseOptions(_3a5), $.parser.parseOptions(_3a5, [
			'region',
			{
				split: 'boolean',
...
(function ($) {
	...
	$.fn.menu.parseOptions = function (_3df) {
		return $.extend({ }, $.parser.parseOptions(_3df, [
			'left',
			'top',
			{
				minWidth: 'number',
...
(function ($) {
	...
	$.fn.menubutton.parseOptions = function (_3f3) {
		var t = $(_3f3);
		return $.extend({ }, $.fn.linkbutton.parseOptions(_3f3), $.parser.parseOptions(_3f3, [
			'menu',
			{
				plain: 'boolean',
				duration: 'number'
...
(function ($) {
	...
	$.fn.splitbutton.parseOptions = function (_3fb) {
		var t = $(_3fb);
		return $.extend({ }, $.fn.linkbutton.parseOptions(_3fb), $.parser.parseOptions(_3fb, [
			'menu',
			{
				plain: 'boolean',
				duration: 'number'
...
(function ($) {
	...
	$.fn.searchbox.parseOptions = function (_41c) {
		var t = $(_41c);
		return $.extend({ }, $.parser.parseOptions(_41c, [
			'width',
			'height',
			'prompt',
			'menu'
...
(function ($) {
	...
	$.fn.validatebox.parseOptions = function (_441) {
		var t = $(_441);
		return $.extend({ }, $.parser.parseOptions(_441, [
			'validType',
			'missingMessage',
			'invalidMessage',
			'tipPosition',
...
(function ($) {
	...
	$.fn.numberbox.parseOptions = function (_48e) {
		var t = $(_48e);
		return $.extend({ }, $.fn.validatebox.parseOptions(_48e), $.parser.parseOptions(_48e, [
			'width',
			'height',
			'decimalSeparator',
			'groupSeparator',
...
(function ($) {
	...
	$.fn.calendar.parseOptions = function (_4bd) {
		var t = $(_4bd);
		return $.extend({ }, $.parser.parseOptions(_4bd, [
			'width',
			'height',
			{
				firstDay: 'number',
...
(function ($) {
	...
	$.fn.spinner.parseOptions = function (_4da) {
		var t = $(_4da);
		return $.extend({ }, $.fn.validatebox.parseOptions(_4da), $.parser.parseOptions(_4da, [
			'width',
			'height',
			'min',
			'max',
...
(function ($) {
	...
	$.fn.timespinner.parseOptions = function (_500) {
		return $.extend({ }, $.fn.spinner.parseOptions(_500), $.parser.parseOptions(_500, [
			'separator',
			{
				showSeconds: 'boolean',
				highlight: 'number'
...
(function ($) {
	...
	function _557(_5a1, _5a2) {
		...
		if (_5a3 == undefined || _5a3.length == 0) {
			return [];
		}
		var _5a4 = [];
		function _5a5(_5a6) {
	...
	function _577(_644, _645) {
		...
		function _647() {
			// 此处去调用$.fn.datagrid.defaults中定义的loader函数 (注意：不是$.fn.datagrid.methods中的loaded函数)
			// 其中第三个参数是用于ajax的回调函数
	...
	$.fn.datagrid = function (_64d, _64e) {
		...
		return this.each(function () {
			...
			if (!opts.url) {
					...
					_515(gridObj);
					if (opts.data) {
						_578(gridObj, opts.data);
						_630(gridObj);
					} else {
						var data = $.fn.datagrid.parseData(gridObj);
						if (data.total > 0) {
							_578(gridObj, data);
							_630(gridObj);
						}
	...
	function myfixCol(gridOptions) {
		...
		var addWidth = 0;
		if (gridOptions.colWidthArr == null) {
			gridOptions.colWidthArr = new Array();
			addWidth = 15;
		}
		...
		bodyTds.each(function (i, obj) {
		  ...
		  if (headerTdWidth > bodyTdWidth) {
		      headerTdWidth = headerTdWidth + addWidth;
		  } else {
		      headerTdWidth = bodyTdWidth + addWidth;
		  }
		...
		var headerTable = $(".datagrid-view2 .datagrid-header .datagrid-header-inner table");
		var bodyTable = $(".datagrid-view2 .datagrid-body table");
		//循环完毕即能得到总得宽度设置到头部table和数据主体table中
		totalWidth = headerTable.width();
		if (totalWidth > bodyTable.width()) {
			bodyTable.width(totalWidth);
		} else {
			headerTable.width(bodyTable.width());
		}
		//if (totalWidth > 0) {
	...
	$.fn.datagrid.parseOptions = function (_6cc) {
		var t = $(_6cc);
		return $.extend({ }, $.fn.panel.parseOptions(_6cc), $.parser.parseOptions(_6cc, [
			'url',
			'toolbar',
			'idField',
			'sortName',
...
(function ($) {
	...
	$.fn.treegrid.parseOptions = function (_7f7) {
		return $.extend({ }, $.fn.datagrid.parseOptions(_7f7), $.parser.parseOptions(_7f7, [
			'treeField',
			{
				animate: 'boolean'
			}
...
(function ($) {
	...
	$.fn.combo.parseOptions = function (_898) {
		var t = $(_898);
		return $.extend({ }, $.fn.validatebox.parseOptions(_898), $.parser.parseOptions(_898, [
			'width',
			'height',
			'separator',
			'panelAlign',
...
(function ($) {
	...
	$.fn.combobox.parseOptions = function (_8d7) {
		var t = $(_8d7);
		return $.extend({ }, $.fn.combo.parseOptions(_8d7), $.parser.parseOptions(_8d7, [
			'valueField',
			'textField',
			'groupField',
			'mode',
...
(function ($) {
	...
	$.fn.combogrid.parseOptions = function (_928) {
		var t = $(_928);
		return $.extend({ }, $.fn.combo.parseOptions(_928), $.fn.datagrid.parseOptions(_928), $.parser.parseOptions(_928, [
			'idField',
			'textField',
			'mode'
		]));
...
(function ($) {
	...
	$.fn.datebox.parseOptions = function (_944) {
		return $.extend({ }, $.fn.combo.parseOptions(_944), $.parser.parseOptions(_944, [
			'sharedCalendar'
		]));
	};
...
(function ($) {
	...
	$.fn.datetimebox.parseOptions = function (_961) {
		var t = $(_961);
		return $.extend({ }, $.fn.datebox.parseOptions(_961), $.parser.parseOptions(_961, [
			'timeSeparator',
			{
				showSeconds: 'boolean'
			}
...
(function ($) {
	...
	$.fn.slider.parseOptions = function (_99e) {
		var t = $(_99e);
		return $.extend({ }, $.parser.parseOptions(_99e, [
			'width',
			'height',
			'mode',
			{
